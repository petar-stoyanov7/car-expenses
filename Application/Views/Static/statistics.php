...
<br>Добре дошли в страницата за автомобилни разходи. Това, което виждате е пример за съдържанието на сайта. С помощта на този сайт може да управлявате разходите по автомобила си и да извличате детайлна статистика. Ако желаете да използвате услугите - нужно е да имате регистрация. Регистрация може да направите, като натиснете <a href="/account/register.php">тук</a>.<br>
За вече регистрирани потребители - <a href="/account/login.php">тук</a>.
</div>
<div class="container">

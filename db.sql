...
INSERT INTO `users` VALUES (1,'Admin','$2y$10$hgkmyGrpPTCwgekgqNCgOOTnwdHWD5StseswCRaxYYv6M6ZimVQD2','admins','petar.stoyanov@gmail.com','ÐŸÐµÑ‚ÑŠÑ€','Ð¡Ñ‚Ð¾ÑÐ½Ð¾Ð²','Ð¡Ð¾Ñ„Ð¸Ñ','male',NULL),(2,'ivan85','$2y$10$vmVAhpL44R9.siVX5ElAOOKMFOzI50FsSeVOCRT18iK8Z/Nrlfche','users','ivan@abv.bg','Ivan','Ivanov','Pernik','male',''),(6,'stamat13','$2y$10$hgkmyGrpPTCwgekgqNCgOOTnwdHWD5StseswCRaxYYv6M6ZimVQD2','users','stamat@abv.bg','Stamat','Stamatov','Tutrakan','male',''),(7,'nadia3','$2y$10$GShBkcTqd/Vasc5QfoQZ0OHmsAICcJJ9RT5FrFEYawTn4F2Ix6xPi','users','nade@abv.bg','ÐÐ°Ð´ÐµÐ¶Ð´Ð°','ÐšÐ¾ÑÑ‚Ð¾Ð²Ð°','Ð¢ÐµÑ‚ÐµÐ²ÐµÐ½','female','');
...
-- Dump completed on 2016-08-29 19:31:30
